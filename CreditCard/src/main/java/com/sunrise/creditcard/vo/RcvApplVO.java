package com.sunrise.creditcard.vo;
...
public class RcvApplVO {
	...
	public String getMGT_BBRN() {
		return MGT_BBRN;
	}
	public void setMGT_BBRN(String mGT_BBRN) {
		MGT_BBRN = mGT_BBRN;
	}
	...
	public String toString() {
		return "RcvApplVO [SSN=" + SSN + ", RCV_D=" + RCV_D + ", RCV_SEQ_NO=" + RCV_SEQ_NO + ", APPL_D=" + APPL_D
				+ ", BIRTH_D=" + BIRTH_D + ", HG_NM=" + HG_NM + ", ENG_NM=" + ENG_NM + ", STL_MTD=" + STL_MTD
				+ ", STL_ACT=" + STL_ACT + ", BNK_CD=" + BNK_CD + ", STL_DD=" + STL_DD + ", MGT_BBRN=" + MGT_BBRN
				+ ", APPL_CLAS=" + APPL_CLAS + ", STMT_SND_MTD=" + STMT_SND_MTD + ", BILLADR_ADR1=" + BILLADR_ADR1
				+ ", BILLADR_ADR2=" + BILLADR_ADR2 + ", BILLADR_ZIP=" + BILLADR_ZIP + ", HDP_NO=" + HDP_NO + ", BRD="
				+ BRD + ", SCRT_NO=" + SCRT_NO + ", EMAIL_ADR=" + EMAIL_ADR + ", CRD_NO=" + CRD_NO + ", IMPSB_CLAS="
				+ IMPSB_CLAS + ", IMPSB_CD=" + IMPSB_CD + ", LST_OPR_TM=" + LST_OPR_TM + ", LST_OPR_D=" + LST_OPR_D
				+ ", LST_OPRT_EMPNO=" + LST_OPRT_EMPNO + "]";
	}
}